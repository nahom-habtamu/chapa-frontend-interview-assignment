...
import { Transaction, useTransactions } from "../../data/user/useTransactions";
...
export const UserTransactions: React.FC<UserTransactionsProps> = ({ className }) => {
  const { transactions, loading: transactionsLoading } = useTransactions({ limit: 100 }); // Show more transactions
